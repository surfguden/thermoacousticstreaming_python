...
namespace Hamamatsu.DCAM4
{
    ...
    public struct DCAMERR : IEquatable<DCAMERR>
    {
        ...
        public static readonly DCAMERR INVALID_REALTIMEGAINCORRECTREGIONS   = new DCAMERR(ERR.INVALID_REALTIMEGAINCORRECTREGIONS);
        ...
        public string text()
        {
            ...
            case ERR.INVALID_REALTIMEGAINCORRECTREGIONS:return "INVALID_REALTIMEGAINCORRECTREGIONS";
    ...
    public struct DCAMIDPROP : IEquatable<DCAMIDPROP>
    {
        ...
        public static readonly DCAMIDPROP FULLWELL_MODE                     = new DCAMIDPROP(0x003001B0);
        ...
        public static readonly DCAMIDPROP READOUT_FREQUENCY                 = new DCAMIDPROP(0x00400160);
    ...
    public struct DCAMPROP : IEquatable<DCAMPROP>
    {
        ...
        public struct FULLWELL_MODE     {
            public static readonly DCAMPROP STANDARD                = new DCAMPROP(0);          // "STANDARD"
            public static readonly DCAMPROP HIGH                    = new DCAMPROP(1);          // "HIGH"
        };
