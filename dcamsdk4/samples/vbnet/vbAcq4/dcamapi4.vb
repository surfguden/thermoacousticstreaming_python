...
Namespace Hamamatsu
    Public Class DCAM4
        ...
        Public Enum DCAMERR
            ...
            INVALID_REALTIMEGAINCORRECTREGIONS  = &H80000843    ' the combination of hpos and hsize for realtime correct region is invalid. e.g. DCAM_IDPROP_REALTIMECORRECTREGION_HPOS + DCAM_IDPROP_REALTIMECORRECTREGION_HSIZE is grater than the number of horizontal pixel.
        ...
        Public Enum DCAMIDPROP
            ...
            FULLWELL_MODE                       = &H003001B0    ' R/W, mode,    "FULLWELL MODE"
            ...
            READOUT_FREQUENCY                   = &H00400160    ' R/W, frequency, "READOUT FREQUENCY"
        ...
        Public Enum DCAMPROPVALUE
            ...
            FULLWELL_MODE__STANDARD                             = 0             ' "STANDARD"
            FULLWELL_MODE__HIGH                                 = 1             ' "HIGH"
