"""LabVIEW VISA-style serial configuration helpers retained for migration parity.

These helpers are covered by tests/test_application.py but are not used by
current production modules. Their removal is a separate cleanup decision.
"""
