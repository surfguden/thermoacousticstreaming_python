...
rem Launch the Thermo Acoustic Streaming Qt GUI v2 preview from this repository.
rem v2 (MainWindowV2) is an in-development preview UI -- see
rem docs/legacy_unresolved_items.md. It is NOT the default/primary UI; use
rem launch_gui.bat for the validated day-to-day v1 UI (MainWindow) instead.
